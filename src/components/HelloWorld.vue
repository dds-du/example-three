<template>
	<a-config-provider :locale="locale">
		<div class="container">
			...
			<div class="bot-table">
				<a-table :data-source="dialogTableData" :pagination="false" :height="300">
					<a-table-column key="label" title="标题" :width="240">
						<template #default="scope: any">
							<a-input @blur="onInput(scope.value)" v-model:value="scope.value.label" />
						</template>
					</a-table-column>
					<a-table-column key="x" data-index="x" title="X"></a-table-column>
					<a-table-column key="y" data-index="y" title="Y"></a-table-column>
					<!-- <a-table-column key="z" data-index="z" title="Z"></a-table-column> -->
					<a-table-column key="left" data-index="left" title="Left"></a-table-column>
					<a-table-column key="top" data-index="top" title="Top"></a-table-column>
					<a-table-column title="操作" width="120">
						<template #default="scope: any">
							<a-popconfirm title="确定删除该项？" @confirm="deletePoint(scope.value.code, scope.index)">
